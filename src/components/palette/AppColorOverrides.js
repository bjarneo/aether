    ...
    class AppColorOverrides extends Adw.ExpanderRow {
        ...
        _getColorVarLabel(colorVar, appName) {
            ...
            const colorDescriptionsByApp = {
                ...
                neovim: {
                    background: 'Editor background (bg, bg_dark)',
                    foreground: 'Default text color (fg)',
                    red: 'Errors, variables, diff deleted (red)',
                    green: 'Strings, diff added (green)',
                    yellow: 'Classes, types, search (yellow)',
                    blue: 'Functions, methods (blue)',
                    magenta: 'Keywords, storage (purple)',
                    cyan: 'Regex, escape chars (cyan)',
                    white: 'Dark foreground (fg_dark)',
                    bright_black: 'Comments, line highlight (comment, bg_highlight)',
                    bright_red: 'Constants, integers (orange)',
                    bright_magenta: 'Special keywords (magenta)',
                },
            };
